...
test('check input is format for (000) with "space" separator', async () => {
  expect(numpresso(1000_000_000).format("(000)", " ")).toBe(
    "1 (000) (000) (000)"
  );
});
...
test("check input is fixed digits by 4", async () => {
  expect(numpresso(100_000).fixedDigits(4).toNumber()).toBe(1000);
  expect(numpresso(100_000.56).fixedDigits(4).toNumber()).toBe(1000.56);
  expect(numpresso(100.56).fixedDigits(1).toNumber()).toBe(1.56);
  expect(numpresso(100).fixedDigits(0).toNumber()).toBe(0);
});

test("check input is fixed digits by 4 includes decimal", async () => {
  expect(numpresso(100.56).fixedDigits(4, true).toNumber()).toBe(1);
  expect(numpresso(1200.56).fixedDigits(4, true).toNumber()).toBe(12);
  expect(numpresso(10.56).fixedDigits(4, true).toNumber()).toBe(0);
  expect(numpresso(10.5643).fixedDigits(4, true).toNumber()).toBe(10);
  expect(numpresso(10.56431).fixedDigits(4, true).toNumber()).toBe(10.5);
});

test("check input is scientific", async () => {
  expect(numpresso(1e15).toScientific().toString()).toBe("1000000000000000");
  expect(numpresso(1e15).toScientific().toCurrency()).toBe(
    "1,000,000,000,000,000"
  );
  expect(numpresso(1e15).toScientific().format("[00]")).toBe(
...
test("check input is parsed number", async () => {
  expect(numpresso(1000).parseNumber().toNumber()).toBe(1000);
  expect(numpresso("1,000").parseNumber().toString()).toBe("1000");
});
